...
public class PayOrderConsumer {
    ...
    public void init() {
        ...
        String topics = PropertyUtils.getValue("kafka.pay.order.topics");
        ...
        int partitionCount = Integer.parseInt(PropertyUtils.getValue("kafka.pay.order.partition.count"));
    ...
    public static void main(String[] args) {
        PayOrderConsumer payOrderConsumer = new PayOrderConsumer();
        payOrderConsumer.init();
    }

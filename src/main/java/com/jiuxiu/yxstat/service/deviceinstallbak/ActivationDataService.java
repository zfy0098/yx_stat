    ...
    public void initialization(String[] args){
        ...
        stream.foreachRDD(new VoidFunction<JavaRDD<ConsumerRecord<String, String>>>() {
            ...
            public void call(JavaRDD<ConsumerRecord<String, String>> consumer) throws Exception {
                ...
                // 保存child id 信息
                ChildIdActivationDataService.childIdActivationData(javaRDD);
                // 保存 app id 信息
                AppIDActivationDataService.appidActivationData(javaRDD);
                // 保存 app channel id 信息
                AppChannelIdActivationDataService.appChannelIDActivationData(javaRDD);
                // 保存 channel id 信息
                ChannelIdActivationDataService.ChannelActivationData(javaRDD);
                // 保存 package id 信息
                PackageActivationDataService.pacakgeActivationData(javaRDD);

...
public class SaveDataUtils {
    ...
    public static void saveRegisterLoginCount(String date, int appID, int childID, int channelID, int appChannelID, int packageID) {
        ...
        if (childIDGuestRegisterCount != 0 || childIDAccountRegisterCount != 0 || childIDPhoneRegisterCount != 0 || childIDQQRegisterCount != 0
            ...
            statUserRegisterLoginChildIDDao.saveChildIDRegisterLoginCount(date, appID, childID, childIDLoginCount, childIDGuestRegisterCount, childIDAccountRegisterCount, childIDPhoneRegisterCount, childIDQQRegisterCount, childIDWXRegisterCount, childIDTotalRegisterCount);
        }

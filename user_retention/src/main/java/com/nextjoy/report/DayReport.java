...
import com.nextjoy.report.dao.DayReportAppChannelIDDao;
import com.nextjoy.report.dao.DayReportAppIDDao;
import com.nextjoy.report.dao.DayReportChannelIDDao;
import com.nextjoy.report.dao.DayReportChildIDDao;
import com.nextjoy.report.dao.DayReportPackageIDDao;
...
public class DayReport extends StatDataBase {
    ...
    private DayReportAppIDDao dayReportDao = DayReportAppIDDao.getInstance();

    private DayReportChildIDDao dayReportChildIDDao = DayReportChildIDDao.getInstance();

    private DayReportChannelIDDao dayReportChannelIDDao = DayReportChannelIDDao.getInstance();

    private DayReportAppChannelIDDao dayReportAppChannelIDDao = DayReportAppChannelIDDao.getInstance();

    private DayReportPackageIDDao dayReportPackageIDDao = DayReportPackageIDDao.getInstance();

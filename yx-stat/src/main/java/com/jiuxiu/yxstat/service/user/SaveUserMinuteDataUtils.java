...
/**
 * Created with IDEA by ZhouFy on 2018/7/2.
 *
 * @author ZhouFy
 */
public class SaveUserMinuteDataUtils {
    ...
    public static void saveMinuteRegisterLoginCount(String time, int appID, int childID, int channelID, int appChannelID, int packageID) {

        long appIDGuestRegisterCount = JedisUtils.getSetScard(JedisPoolConfigInfo.statRedisPoolKey, time + JedisUserStatisticsKeyConstant.APP_ID_REGISTER_COUNT + appID + ":" + RegisterType.GUEST_REGISTER.getType());
        long appIDAccountRegisterCount = JedisUtils.getSetScard(JedisPoolConfigInfo.statRedisPoolKey, time + JedisUserStatisticsKeyConstant.APP_ID_REGISTER_COUNT + appID + ":" + RegisterType.ACCOUNT_REGISTER.getType());
        ...
        long childIDAccountRegisterCount = JedisUtils.getSetScard(JedisPoolConfigInfo.statRedisPoolKey, time + JedisUserStatisticsKeyConstant.CHILD_ID_REGISTER_COUNT + childID + ":" + appID + ":" + RegisterType.ACCOUNT_REGISTER.getType());
        ...
        long channelIDAccountRegisterCount = JedisUtils.getSetScard(JedisPoolConfigInfo.statRedisPoolKey, time + JedisUserStatisticsKeyConstant.CHANNEL_ID_REGISTER_COUNT + channelID + ":" + childID + ":" + appID + ":" + RegisterType.ACCOUNT_REGISTER.getType());
        ...
        long appChannelIDAccountRegisterCount = JedisUtils.getSetScard(JedisPoolConfigInfo.statRedisPoolKey, time + JedisUserStatisticsKeyConstant.APP_CHANNEL_ID_REGISTER_COUNT + appChannelID + ":" + channelID + ":" + childID + ":" + appID + ":" + RegisterType.ACCOUNT_REGISTER.getType());
        ...
        long packageIDAccountRegisterCount = JedisUtils.getSetScard(JedisPoolConfigInfo.statRedisPoolKey, time + JedisUserStatisticsKeyConstant.PACKAGE_ID_REGISTER_COUNT + packageID + ":" + appChannelID + ":" + channelID + ":" + childID + ":" + appID + ":" + RegisterType.ACCOUNT_REGISTER.getType());
